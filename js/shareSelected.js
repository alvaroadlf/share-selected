...
(function (exports) {
    ...
    exports.shareSelected = function (element, args) {
        ...
        parameters = extend({
            ...
            anchorsClass: '',
            twitterUsername: '',
            facebookAppID: '2219389284744597',
...
if (window.jQuery) {
    (function ($, shareSelected) {
        ...
        $.fn.shareSelected = function (options) {
            return shareSelectedify(this.selector, options);
        };
    }(jQuery, shareSelected));
}